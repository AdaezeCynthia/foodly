              ...
              <div>
                <div>
                  <img
                    src={item.img}
                    alt={item.name}
                    className=" border-none hover:scale-105 duration-300 w-full h-[250px] object-cover rounded-lg "
                  />
                </div>
                <p className="font-bold my-4">{item.recipe}</p>
                ...
                <div>
                  ...
                  >
                    <p className="flex">
                      Click
                      <PiBowlFoodFill
                        className="text-indigo-600  border-none hover:scale-105 mx-1 "
                        size={25}
                      />
                      to
